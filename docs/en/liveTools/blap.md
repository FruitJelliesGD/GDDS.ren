...
#### The system automatically polls when no live stream is running, and automatically refreshes the webpage and announces the start of a live stream via voice when it detects that a live stream has started.
